...
\pause
\Large
Trust me, I'm NOT an expert either.
\end{center}
\end{frame}
...
\begin{frame}{At the centre of all this is}
...
\begin{frame}{\#1: Think First, Then Delegate}
    Start from what the reader or user actually needs before you start delegating.
\pause
...
\pause
\vspace{0.8em}
If you don't clarify your work and go into the task confused, AI will amplify that confusion. Because it is fundamentally trained on the "average" of all work that's out there. 
\pause
Lack of guidance will produce mediocre work - and poor guidance can produce even worse.

\pause
\vspace{0.8em}
\textit{The thinking is the work. Delegation comes after. Think of AI as a talented junior you can delegate work to.}
\end{frame}
...
\break
\pause
What people refer to as prompt engineering is difficult to generalise. It depends on the context of your field and your specific role - context that \textit{only} you can provide.


\break
\pause
You still have to supply the context, constraints, standards, and domain knowledge that make the output useful.
If all of that could be automated and generalised, the frontier AI labs wouldn’t still be hiring so aggressively.
...
This shifts where your value sits: less in drafting, more in judgment, context, and coordination. It also means all roles are evolving closer into product roles.
...
\begin{frame}
    \begin{center}
        ...
        \vspace{2em}
        {\tiny This one's an original, no reference.}
    \end{center}
\end{frame}
...
AI made writing cheap. It did not make reading cheap.
...
\small
Writing has never been the hardest part of the process - reading is.
