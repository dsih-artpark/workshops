...
Describe what you want like you'd tell a colleague.
Use direct and simple language. Iterate from the response. (More on that in \#3.)
...
\begin{frame}
    \begin{center}
        ...
        \vspace{2em}
        {\normalsize This one's an original as well. Your core work is often navigating that crash, with or without AI.}
    \end{center}
\end{frame}
...
\footnotesize
    \begin{enumerate}
        \item As and when something works, write it down in an md file. You can easily reference them as context.
        \begin{enumerate}
            \footnotesize
            \item Writing is important! You writing down what worked for yourself is part of that.
        \end{enumerate}
        \pause
        \item Use the coding desktop apps in the folders. You don't need to be a coder!
        \pause
        \item Keep reusable snippets handy. (Apps like Raycast have these features built in.)
        \pause
...
\vspace{0.6em}
\pause
Above all else, be curious. Read and explore. Ask lots of questions And share what you learn!
...
\begin{frame}{What To Take With You}
\begin{itemize}
...
\vspace{1em}
Reach out if you have workflows you'd like to share. Future workshops are dependent on your interest.

Slack Channel: \#technical-support. Or DM!
\end{frame}
